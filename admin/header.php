...
<head>
	...
	<title> Platform Online Course</title>
...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-dark">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<span class="nav-link">Sistem Informasi Pengelola Kursus Online</span>
				</li>
			</ul>
		</nav>
		<!-- /.navbar -->
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="../adminlte310/index3.html" class="brand-link">
				<img src="../adminlte310/dist/img/k.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
				<span class="brand-text font-weight-light">Kursus APP</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="../adminlte310/dist/img/user8-128x128.jpg" class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
						<a href="http://Poliban.ac.id" class="d-block" target="_blank">Ardi</a>
					</div>
				</div>
            ...
            with font-awesome or any other icon font library -->
						...
						<li class="nav-item">
							<a href="?page=kursus" class="nav-link">
						...
						<li class="nav-item">
							<a href="../tampil.php?page=logout" class="nav-link">
